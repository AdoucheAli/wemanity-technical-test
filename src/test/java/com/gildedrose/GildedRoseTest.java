...
public class GildedRoseTest {
    ...
    @Test
    public void should_increaseInQuality_when_agedBrieAndQualityEquals50() {
    ...
    @Test
    public void should_increaseInQuality_when_backstageAndQualityEquals50() {
    ...
    public void should_increaseInQualityBy2_when_backstageAndSellInBetween10And6() {
        ...
        Item[] items = new Item[] { new Item(BACKSTAGE, 10, initialBackstageQuality), new Item(BACKSTAGE, 6, initialBackstageQuality) };
    ...
    public void should_increaseInQualityBy3_when_backstageAndSellInBetween5And1() {
        ...
        Item[] items = new Item[] { new Item(BACKSTAGE, 5, initialBackstageQuality), new Item(BACKSTAGE, 1, initialBackstageQuality) };
    ...
    @Test
    public void should_increaseInQuality_when_backstageAndAfterTheCancert() {
    	int initialBackstageQuality = 50;
